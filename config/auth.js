module.exports = {
	'facebookAuth' : {
		...
		'callbackURL': process.env.FACEBOOK_APP_CALLBACKURL||'http://limber.stackroute.in/auth/facebook/callback'
	},
	'googleAuth' : {
		...
		'callbackURL': process.env.GOOGLE_APP_CALLBACKURL||'http://limber.stackroute.in/auth/google/callback'
},
	'githubAuth' : {
	...
	'dropboxAuth':{
		...
		'callbackURL': process.env.DROPBOX_APP_CALLBACKURL||"http://localhost:8080/auth/dropbox/callback"
